...
set _DeploySetParametersFile=%RootPath%IngeniBridge.Server.v.1.0.6.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%IngeniBridge.Server.v.1.0.6.zip" (
echo "%RootPath%IngeniBridge.Server.v.1.0.6.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%IngeniBridge.Server.v.1.0.6.deploy-readme.txt" (
...
start notepad "%RootPath%IngeniBridge.Server.v.1.0.6.deploy-readme.txt"
)
echo =========================================================
goto :eof
