    ...
    class Program
    {
        ...
        static int Main ( string [] args )
        {
            ...
            try
            {
                ...
                Task<HttpResponseMessage> response = client.GetAsync ( Program.url + "/REQUESTER/RetrieveDatas?PageNumber=0&PageSize=2&CallingApplication=IngeniBridge.TestServer" ); // here find all datas
                ...
                response = client.GetAsync ( Program.url + "/REQUESTER/RetrieveDatas?CorrelationCriteria=TimedData.TimeSeriesExternalReference=EXTREF 004&PageNumber=0&PageSize=10&CallingApplication=IngeniBridge.TestServer" );
